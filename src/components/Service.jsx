...
const Service = () => {
  return (
    <div className='flex flex-col items-center bg-secondary padding overflow-hidden lg:h-screen justify-center'>
      ...
      <div className='flex w-full items-center flex-col gap-16 md:flex-row mt-16 text-center justify-evenly md:flex-wrap lg:flex-nowrap'>
        <div className='flex flex-col items-center w-full gap-5 sm:w-96 lg:h-full lg:w-full'>
        ...
        <div className='flex flex-col items-center w-full gap-5 sm:w-96 lg:h-full lg:w-full'>
          ...
          <h2 className='font-kodchasan_M text-xl text-primary'>Lorem, ipsum dolor.</h2>
          <p className='text-muted-foreground'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique saepe quod officia?</p>
        </div>
      </div>
