...
const Projects = () => {
  return (
    <div className='sm:py-16 px-5'>
      ...
      <div className='flex flex-wrap justify-center my-5 sm:my-10 p-6 md:p-12 gap-7'>
        <div className='h-[19rem] w-[17rem] sm:w-[25rem] sm:h-[27rem] rounded-lg relative overflow-hidden group border'>
          ...
          <div className='absolute top-0 left-0 h-full w-full pt-6 px-5 text-white'>
            ...
            <p className='text-gray-300 text-base mt-1 tracking-wide xs:line-clamp-4 sm:line-clamp-[8]'>At Homely, we believe that finding your perfect home should feel as comfortable as stepping into your own living room. Our user-friendly platform offers a comprehensive selection of real estate options, whether you’re looking to buy, rent, or explore properties. Discover a diverse array of houses for sale, tailored to fit every lifestyle and budget.
            </p>
            <div className='flex gap-5 mt-3 sm:mt-8 justify-center'>
              <Link className='border py-1 px-2 text-xs sm:text-xl hover:bg-white/10'>Live Demo</Link>
              <Link className='border py-1 px-2 text-xs sm:text-xl hover:bg-white/10'>Source Code</Link>
            </div>
          </div>
        </div>
        <div className='h-[19rem] w-[17rem] sm:w-[25rem] sm:h-[27rem] rounded-lg relative overflow-hidden group border'>
          ...
          <div className='absolute top-0 left-0 h-full w-full pt-6 px-5 text-white'>
            ...
            <p className='text-gray-300 text-base mt-1 tracking-wide xs:line-clamp-4 sm:line-clamp-[8]'>At AutoCare, we understand that regular maintenance is the key to extending the life of your vehicle and ensuring safety on the road. Our experienced technicians provide high-quality service with a commitment to excellence. With transparent pricing and a customer-first approach, we make car care convenient and stress-free.
            </p>
            <div className='flex gap-5 mt-3 sm:mt-8 justify-center'>
              <Link className='border py-1 px-2 text-xs sm:text-xl hover:bg-white/10'>Live Demo</Link>
              <Link className='border py-1 px-2 text-xs sm:text-xl hover:bg-white/10'>Source Code</Link>
